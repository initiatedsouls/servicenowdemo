...
import com.servicenow.demo.core.cost.SolutionCostCalculator;
import com.servicenow.demo.core.vehicle.VehicleFleetManager;


public class VRPAlgorithmBuilder {
    ...
    public static VehicleRoutingAlgorithm createAlgorithm(VehicleRoutingProblem vehicleRoutingProblem) {
        return VRPAlgorithmBuilder.Builder.newInstance(vehicleRoutingProblem).buildAlgorithm();
    }
    ...
    public static class Builder {
        ...
        private Random random = new Random(521131L);
        ...
        public VehicleRoutingAlgorithm buildAlgorithm() {
            return new VRPAlgorithmBuilder(this).create(vrp);
        }
    ...
    private VRPAlgorithmBuilder(Builder builder) {
