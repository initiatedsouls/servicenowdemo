...
import com.servicenow.demo.core.InsertionData;
import com.servicenow.demo.core.VehicleRoutingProblem;
...
public class DefaultScorer  {
    ...
    private double getDistance(Location loc1, Location loc2) {
        return vrp.getTransportCosts().getTransportCost(loc1, loc2, 0., null);
    }
